...
in
{
  ...
  services.syncthing = {
    ...
    settings = {
      devices = lib.listToAttrs (map mkDeviceAttr [
        { name = "Surfux"; autoAcceptFolders = true; }
        { name = "Magic"; autoAcceptFolders = true; }
        { name = "Franken"; autoAcceptFolders = true; }
      ]);
