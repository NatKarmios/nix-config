...
let
  ...
  zoteroConfigPath = if isDarwin then "Library/Application Support/Zotero" else ".zotero";

  profilesPath = if isDarwin then "${zoteroConfigPath}/Profiles" else "${zoteroConfigPath}/zotero";
...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    home.file = mkMerge (
      [
        {
          "${profilesPath}/profiles.ini" = mkIf (cfg.profiles != { }) { text = profilesIni; };
        }
      ]
